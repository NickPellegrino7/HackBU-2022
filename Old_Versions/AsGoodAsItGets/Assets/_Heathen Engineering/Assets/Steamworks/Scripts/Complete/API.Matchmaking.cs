...
namespace HeathenEngineering.SteamworksIntegration.API
{
    ...
    public static class Matchmaking
    {
        public static class Client
        {
            ...
            /// <param name="pRequestServersResponse"></param>
            /// <returns></returns>
            public static HServerListRequest RequestInternetServerList(AppId_t appId, MatchMakingKeyValuePair_t[] filters, ISteamMatchmakingServerListResponse pRequestServersResponse) => SteamMatchmakingServers.RequestHistoryServerList(appId, filters, (uint)filters.Length, pRequestServersResponse);
            /// <summary>
