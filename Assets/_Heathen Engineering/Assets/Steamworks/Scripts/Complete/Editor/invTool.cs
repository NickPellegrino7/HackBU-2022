        ...
        private void DrawItemEditor()
        {
            ...
            else if (activeBundle != null)
            {
                if (settings.itemBundles.Contains(activeBundle))
                {
                    ...
                    var m_SteamItemDef = EditorGUILayout.IntField(activeBundle.definitionID.m_SteamItemDef);

                    if(activeBundle.definitionID.m_SteamItemDef != m_SteamItemDef)
                    {
                        activeBundle.definitionID.m_SteamItemDef = m_SteamItemDef;
                        EditorUtility.SetDirty(activeBundle);
                    }
