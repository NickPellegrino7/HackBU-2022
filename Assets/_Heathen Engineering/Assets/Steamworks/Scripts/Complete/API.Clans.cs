...
namespace HeathenEngineering.SteamworksIntegration.API
{
    ...
    public static class Clans
    {
        public static class Client
        {
            ...
            /// </remarks>
            public static ChatRoom[] JoinedChatRooms => joinedRooms.ToArray();
            private static readonly List<ChatRoom> joinedRooms = new List<ChatRoom>();
            ...
            public static void JoinChatRoom(CSteamID clanId, Action<ChatRoom, bool> callback)
            {
                if (callback == null)
                    return;
                ...
                var handle = SteamFriends.JoinClanChatRoom(clanId);
